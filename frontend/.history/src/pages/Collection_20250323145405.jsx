    ...
    <div className="flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t">
      <div className="min-w-60">
        ...
        <div className={`border border-gray-300 pl-5 py-3 mt-6 ${showFilter ? '' : 'hidden'} sm:block`}>
          <p className="mb-3 text-sm font-medium">DANH MỤC</p>
          <div className="flex flex-col gap-2 text-sm font-light text-gray-700">
            <label><input className="w-3" type="checkbox" value="Nam" onChange={toggleCategory} /> Nam</label>
            <label><input className="w-3" type="checkbox" value="Nữ" onChange={toggleCategory} /> Nữ</label>
            <label><input className="w-3" type="checkbox" value="Phụ Kiện" onChange={toggleCategory} /> Phụ Kiện</label>
          </div>
        </div>
        ...
        <div className={`border border-gray-300 pl-5 py-3 my-5 ${showFilter ? '' : 'hidden'} sm:block`}>
          <p className="mb-3 text-sm font-medium">LOẠI</p>
          <div className="flex flex-col gap-2 text-sm font-light text-gray-700">
            <label><input className="w-3" type="checkbox" value="Áo Khoác Ngoài" onChange={toggleSubCategory} /> Áo Khoác Ngoài</label>
            <label><input className="w-3" type="checkbox" value="Đầm" onChange={toggleSubCategory} /> Đầm</label>
            <label><input className="w-3" type="checkbox" value="Quần Dài" onChange={toggleSubCategory} /> Quần Dài</label>
          </div>
        </div>
      </div>
